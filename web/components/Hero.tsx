...
export default function Hero() {
  return (
    <section id="home" className="px-6 pb-24 pt-14 sm:pb-32 sm:pt-20">
      <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.08fr)] lg:gap-16">
        <Reveal>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            ...
            <a href="#pricing" className="btn-secondary h-12 px-6 text-[15px]">
              See pricing
            </a>
          </div>
